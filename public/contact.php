...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    KMM Institue of Post Graduate Studies<br> Rami Reddy Palli,Rangampet Road, Tirupati, India 517102<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 98885520414,9866742584,0877-2289105</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="kmmips@gmail.com">kmmips@example.com</a>
                </p>
